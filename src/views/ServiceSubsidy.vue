<template>
  <div class="serviceSubsidy">
    <van-tabs
      ...
      animated
    >
      <van-tab title="补贴情况公告" name="announcement">
        <!-- 搜索 -->
        <van-search
        ...
        />
        <ServiceAnnouncement :type="active" />
      </van-tab>
      <van-tab title="资金使用情况" name="situation">
        <!-- 所有下拉菜单 -->
        <div class="d-flex ai-center jc-between bg-white van-hairline--top">
          ...
          >
            <template #reference>
              <div
                class="filterQa d-flex ai-center jc-between box-b pl-50 pr-74"
              >
                <div class="fs-36 fw-6 text-black-31">
      ...
      <van-tab title="补贴产品查询" name="search">
        <!-- 搜索 -->
        <van-search
...
<script>
import ServiceAnnouncement from "../components/ServiceAnnouncement.vue";
export default {
  name: "ServiceSubsidy",
  components: {
    ServiceAnnouncement,
